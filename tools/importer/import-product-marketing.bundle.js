var CustomImportScript = (() => {
  ...
  // tools/importer/import-product-marketing.js
  var import_product_marketing_exports = {};
  __export(import_product_marketing_exports, {
    default: () => import_product_marketing_default
  });
  ...
  var import_product_marketing_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_product_marketing_exports);
})();
